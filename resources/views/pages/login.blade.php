...
<body>
        ...
        <div class="col-xl-5 col-lg-6 col-md-8 d-flex flex-column mx-auto">
          <div class="card card-plain login-card bg-white shadow-sm">
            <div class="card-header pb-0 text-center bg-transparent mt-4 border-0">
              <h3 class="font-weight-bolder" style="color: #b0b435;">Selamat Datang Kembali</h3>
              <p class="mb-0 text-muted" style="font-size: 14px;">Masukkan email dan kata sandi Anda untuk masuk</p>
            </div>
            <div class="card-body">
              <form method="POST" action="/login">
                ...
                <div class="mb-3">
                  ...
                  <input type="email" name="email" value="{{ old('email') }}" placeholder="Masukkan Email" class="form-control px-3 py-2" style="border-radius: 8px;">
                </div>
                <div class="mb-4">
                  <label class="form-label font-weight-bold text-dark text-sm">Kata Sandi</label>
                  <input type="password" name="password" class="form-control px-3 py-2" placeholder="Masukkan kata sandi" style="border-radius: 8px;">
                </div>
                <div class="text-center">
                  <button type="submit" class="btn w-100 mb-0 btn-theme" style="border-radius: 8px; padding: 12px 0;">Masuk</button>
                </div>
              </form>
            </div>
            ...
            <div class="card-footer text-center pt-0 px-lg-2 px-1 border-0 bg-transparent mb-3">
              <p class="mb-0 text-sm mx-auto">
                Belum punya akun?
                <a href="/register" class="font-weight-bolder" style="color: #b0b435;">Daftar</a>
              </p>
            </div>
  ...
  <script>
      document.addEventListener("DOMContentLoaded", function() {
          ...
          @endif
          @if($errors->any())
              Swal.fire({ icon: 'error', title: 'Oops...', text: 'Terjadi kesalahan, periksa email atau kata sandi anda!', confirmButtonColor: '#b0b435' });
          @endif
          @if(session('success'))
